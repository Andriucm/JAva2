...
public class MultiVentanaUsuarioContFoco2 extends JFrame implements ActionListener {

	/**
	 * 
	 */
	private static final long serialVersionUID = 7059968486130803409L;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					MultiVentanaUsuarioContFoco2 frame = new MultiVentanaUsuarioContFoco2();
	 ...
	 * Create the frame.
	 */
	public MultiVentanaUsuarioContFoco2() {
