			...
			if (DNI.equals("")) {
				...
				if (dlmDNI.contains(DNI)) {
					...
					if ((Media > 10.0) || (Media < 0.0)) {
						JOptionPane.showMessageDialog(this, (String) "Error. La media " + Media + " No está entre el 0 y el 10",
						...
						JOptionPane.showMessageDialog(this,
								(String) "Posición " + posicion + ". DNI " + DNI + " y nombre " + Nombre + " con una media de " + Media,
