...
public class VentanaCuantoCin extends JFrame {

	/**
	 * 
	 */
	private static final long serialVersionUID = -851349950175441535L;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					VentanaCuantoCin frame = new VentanaCuantoCin();
